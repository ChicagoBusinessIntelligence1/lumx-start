...
gulp.task('serve',  function() {
    ...
    //gulp.watch("app/bower-components/lumx/**/*.*").on('change', reload);
});
...
var paths = {
    ...
    templates: [
        'demo/js/templates/dropdown_template.js',
        'demo/js/templates/file-input_template.js',
        'demo/js/templates/text-field_template.js',
        'demo/js/templates/search-filter_template.js',
        'demo/js/templates/select_template.js',
        'demo/js/templates/tabs_template.js',
        'demo/js/templates/date-picker_template.js',
        'demo/js/templates/progress_template.js'
    ],
    demo: [
        'demo/**/*',
        '!demo/scss/**/*',
...
gulp.task('tpl:dropdown', function()
{
    return gulp.src('modules/dropdown/views/*.html')
        ...
        .pipe(gulp.dest('demo/js/templates'));
});
